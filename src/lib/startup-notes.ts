...
export const STARTUP_NOTES: StartupNote[] = [
    {
        ...
        description: 'Analysis of BuildBear Labs\' blockchain testing infrastructure platform and Series A opportunity. Exploring market dynamics, technical differentiation, and investment considerations for this Singapore-based developer tools company.',
...
export function getNotesChronological(): StartupNote[] {
    return getPublishedNotes().sort((a, b) =>
